...
import UbahPelangganScreen from './UbahPelanggan';
import TambahPelangganScreen from './TambahPelanggan';
import HapusPelangganScreen from './HapusPelanggan';
import MyFloating from '../../components/MyFloating';
...
const Pelanggan = (navigation) => {
  ...
  useEffect(() => {
    ExecuteQuery('SELECT * FROM tbl_pelanggan ORDER BY id_pelanggan', (e) =>
      setItemData(e),
    );
  }, [isFocused]);
  const Item = (props) => (
    <View style={styles.pelanggan}>
      ...
      <View style={{marginHorizontal: 20, flexDirection: 'row'}}>
        <TouchableWithoutFeedback
          onPress={() =>
            props.navigation.navigation.push('Ubah Pelanggan', {
              id: props.idUser,
            })
          }>
          <Image
            ...
            Alert.alert(
              ...
              [
                {text: 'Batal', onPress: () => console.log('cancle Delete')},
                {
                  text: 'Oke',
                  onPress: () =>
                    props.navigation.navigation.navigate('Hapus Pelanggan', {
                      id: props.idUser,
                    }),
                },
              ],
  ...
  return (
    <>
      ...
      <MyFloating
        click={() => navigation.navigation.push('Tambah Pelanggan')}
      />
    </>
  );
};
    ...
    <NavigationContainer independent={true}>
      <Stack.Navigator>
        ...
        <Stack.Screen
          ...
          component={TambahPelangganScreen}
          options={{headerShown: false}}
        />
        <Stack.Screen
          name="Ubah Pelanggan"
          component={UbahPelangganScreen}
          options={{headerShown: false}}
        />
        <Stack.Screen
          name="Hapus Pelanggan"
          component={HapusPelangganScreen}
          options={{headerShown: false}}
        />
      </Stack.Navigator>
    </NavigationContainer>
