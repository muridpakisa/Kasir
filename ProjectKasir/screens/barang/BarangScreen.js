...
const BarangScreen = () => {
  ...
  const Barang = (navprops) => {
    ...
    useEffect(() => {
      ...
      db.transaction((tx) => {
        tx.executeSql('SELECT * FROM tbl_kategori', [], (tx, results) => {
          var temp = [];
          for (let i = 0; i < results.rows.length; ++i)
            temp.push(results.rows.item(i));
          setKategori(temp);
    ...
    const Item = (props) => (
      <View style={styles.baris}>
        ...
        <View style={styles.aksi}>
          <TouchableOpacity
            onPress={() =>
              props.navprops.navigation.navigate('ubahBarang', {
                id: props.id_barang,
              })
            }>
            <Image
              ...
              Alert.alert(
                ...
                [
                  ...
                  },
                  {
                    text: 'Ok',
                    onPress: () =>
                      props.navprops.navigation.navigate('hapusBarang', {
                        id: props.id_barang,
                      }),
                  },
                ],
        ...
        <View style={styles.headGlobal}>
          <View style={styles.headContainer}>
            <Picker
              ...
              {kategori.map((i, k) => (
                <Picker.Item label={i.kategori} value={i.id_kategori} key={k} />
              ))}
            </Picker>
      ...
      <>
        ...
        <View
          ...
          <TouchableOpacity
            ...
            onPress={() => navprops.navigation.navigate('tambahBarang')}>
            <Image
  ...
  return (
    <NavigationContainer independent={true}>
      <Stack.Navigator>
        ...
        <Stack.Screen
          name="hapusBarang"
          component={HapusBarangScreen}
          options={{headerShown: false}}
        />
        <Stack.Screen
          name="ubahBarang"
          component={UbahBarangScreen}
          options={{headerShown: false}}
        />
      </Stack.Navigator>
    </NavigationContainer>
