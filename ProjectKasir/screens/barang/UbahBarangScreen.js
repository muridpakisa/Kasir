      ...
      tx.executeSql(
        ...
        (tx, results) => {
          ...
          if (len > 0) {
            ...
            updateAllStates(res.id_kategori, res.barang, res.harga, res.stok);
          } else {
            alert('No user found');
            updateAllStates('', '', '');
          }
    ...
    <>
      <View style={styles.container}>
        ...
        <TextInput
          ...
          value={barang}
          onChangeText={(barang1) => setBarang(barang1)}
        />
        ...
        <TextInput
          ...
          value={'' + harga}
          onChangeText={(harga1) => setHarga(harga1)}
        />
        ...
        <TextInput
          ...
          value={'' + stok}
          onChangeText={(stok1) => setStok(stok1)}
        />

        <Mybutton title="Ubah" customClick={updateUser} />
      </View>
